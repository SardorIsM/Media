...
@section('content')
    <div class="container">
        <div class="row flex-column align-items-center">
            <h1>Регистрация на Media</h1>

            <form action="{{ route('registr-submit')  }}" method="post">
                @csrf
                <div class="form-group">
                    <input type="text" name="name" placeholder="Имя" id="name" class="form-control" }}>
                </div>
                <div class="form-group">
                    <input type="text" name="surname" placeholder="Фамилия" id="surname" class="form-control" }}>
                </div>
                <div class="form-group">
                    <input type="text" name="email" placeholder="эл.адресс" id="email" class="form-control">
                </div>
                <div class="form-group">
                    <input type="password" name="password" placeholder="Новый пароль" id="pass" class="form-control">
                </div>
                <div class="form-group">
                    <label for="born">День рождения</label>
                    <span class="_5k_4 d-block"><span>
                        <select aria-label="День" name="day" title="День" class="razmer">
                            ...
                            <option value="8">8</option><option value="9">9</option><option
                                ...
                                value="30">30</option><option value="31">31</option></select><select aria-label="Месяц"
                                                                                                     name="month"
                                                                                                     id="month"
                                                                                                     title="Месяц"
                                                                                                     class="_9407 _5dba _9hk6 _8esg razmer"><option
                                    value="1" selected="1">янв</option><option value="2" >фев</option><option
                                    value="3">мар</option><option value="4">апр</option><option value="5">мая</option><option
                                    value="6">июн</option><option value="7">июл</option><option value="8">авг</option><option
                                    value="9">сен</option><option value="10">окт</option><option value="11">ноя</option><option
                                    value="12">дек</option></select><select aria-label="Год" name="year" id="year"
                                                                            title="Год"
                                                                            class="_9407 _5dba _9hk6 _8esg razmer"><option
                                    value="2021" >2021</option><option value="2020">2020</option><option
                                    value="2019">2019</option><option value="2018">2018</option><option
                                    ...
                                    value="1961">1961</option><option value="1960" selected="1">1960</option><option
                                    ...
                                    value="1905">1905</option></select></span></span>
                </div>
                <div class="form-group">
                    <label>Пол</label>
                    <span class="d-block">
                    <span>
                        <input type="radio" name="gender" id="pol-w" value="1">
                        <label for="pol-w">Женщина</label>
                    </span>
                    <span>
                        <input type="radio" name="gender" id="pol-m" value="2">
                        <label for="pol-m">Мужчина</label>
                    </span>
                </span>

                </div>
                <p class="tekst">Нажимая кнопку Регистрация, вы принимаете Условия, Политику использования данных и Политику в отношении файлов cookie. Вы можете получать от нас SMS-уведомления, отказаться от которых можно в любой момент.</p>
                <button class="btn btn-success knopka">Регистрация</button>
            </form>
        </div>
    </div>
@endsection
