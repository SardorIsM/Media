...
@section('content')
    <div class="container">
        <div class="row flex-column align-items-center">
            <h1>Изменить ваш аккаунт</h1>

            <form action="{{ route('my-page-update-submit', $registr->id)  }}" method="post">
                @csrf
                <div class="form-group">
                    <input type="text" name="name" value="{{$registr->name}}" placeholder="Имя" id="name" class="form-control">
                </div>
                <div class="form-group">
                    <input type="text" name="surname"  value="{{$registr->surname}}" placeholder="Фамилия" id="surname" class="form-control">
                </div>
                <div class="form-group">
                    <input type="text" name="email"  value="{{$registr->email}}" placeholder="эл.адресс" id="email" class="form-control">
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-success knopka">Обновить</button>
            </form>
        </div>
    </div>
@endsection
